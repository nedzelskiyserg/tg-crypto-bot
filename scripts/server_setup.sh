...
echo "=== Готово ==="
echo ""
echo "1. Создайте .env (Google и админы уже в примере) и заполните BOT_TOKEN:"
echo "   sudo -u $APP_USER bash $APP_DIR/scripts/generate_env.sh   # создать/обновить .env из .env.example"
